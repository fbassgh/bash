...
export PATH=$SVN_HOME/bin:$TELEGRAM_HOME/:$MAVEN_HOME/bin:$JEDIT_HOME:$PMD_HOME/bin:$GRAILS_HOME/bin:$GROOVY_HOME/bin:$IDEA_HOME/bin:$GLASSFISH_HOME/bin:$SERVICEMIX_HOME/bin:$GRADLE_HOME/bin:$CATALINA_HOME/bin:$CLOC_HOME:$SOAPUI_HOME/bin:$JAVA_HOME/bin:$NB_HOME/bin:$PATH
